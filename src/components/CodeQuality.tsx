  ...
  render() {
    return (
      <div>
        ...
        {this.state.showAlert && this.renderAlert()} {/* Відображаємо сповіщення */}
      </div>
    );
  }
  ...
  renderBottomA() {
    return (
      <div className="bottomA">
        <button onClick={this.copyCode} className="copy-button">Copy</button>
        <button onClick={this.exportCode} className="export-button">Export</button>
      </div>
    );
  }
